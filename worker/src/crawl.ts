    ...
    await logWorkerCall(
      {
        ...
        requestPayload: { url: url.href },
        responsePayload: {
          title: result.semantic.title,
          metaDescription: result.semantic.metaDescription,
          headingCounts: result.semantic.headingCounts,
          structuredDataTypes: result.semantic.structuredDataTypes,
          lang: result.semantic.langAttribute,
          wordCount: result.contentArchitecture.wordCount,
          navLinkCount: result.contentArchitecture.navLinkCount,
          designSignals: result.designSignals,
          accessibilityScore: result.accessibility.score,
          accessibilityIssues: result.accessibility.issues.slice(0, 8),
    ...
    await logWorkerCall(
      {
        ...
        requestPayload: { url: url.href },
        responsePayload: { error: stringifyErr(err).slice(0, 500) },
      },
      log,
    );
    log.warn(
